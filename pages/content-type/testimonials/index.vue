        ...
        <transition name="fade">
            <div id="admin" class="cms_dashboard" v-if="loaded">
                    ...
                    <div class="action_wrapper">
                        ...
                        <div class="actions">
                            ...
                            <div class="action_buttons">
                                <nuxt-link :to="`${$route.path}/create`" class="action_btn"><svg xmlns="http://www.w3.org/2000/svg" width="17.016" height="17.016" viewBox="0 0 17.016 17.016"><defs></defs><g transform="translate(-553 -381)"><circle class="add" cx="8.508" cy="8.508" r="8.508" transform="translate(553 381)"/><g transform="translate(558.955 386.955)"><line class="add_sign" y2="5.233" transform="translate(2.616 0)"/><line class="add_sign" x2="5.233" transform="translate(0 2.616)"/></g></g></svg>Add a Testimonial</nuxt-link>
                            </div>
                        </div>
                    </div>
                </section>
                <section id="content">
                    ...
                    <pagination :apiRoute="res.testimonials.path" :current="res.testimonials.current_page" :last="res.testimonials.last_page" />
                </section>
            </div>
        </transition>
        <transition name="fade">
            <delete v-if="$store.state.deleteStatus" ref="delete" :url="`api/testimonials`" />
        </transition>
    ...
    export default {
        ...
        methods: {
            ...
            fetchData () {
                const me = this
                me.loader(true)
                me.$axios.get('api/testimonials').then(res => {
                    if (res.data) {
                        setTimeout( () => {
                            me.res = res.data
                            me.totalResults = me.res.testimonials.total
                            me.loaded = true
                        }, 500)
                    }
                }).catch(err => {
