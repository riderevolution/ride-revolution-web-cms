        ...
        <div id="admin" class="cms_dashboard">
            <section id="top_content" class="table">
                ...
                <div class="action_wrapper">
                    <h1 class="header_title">Add a New Shoe Size</h1>
                </div>
            </section>
            <section id="content">
                        ...
                        <div class="form_main_group">
                            <div class="form_flex">
                                <div class="form_group">
                                    ...
                                    <input type="text" name="size" autocomplete="off" class="default_text" autofocus v-validate="'required'">
                                ...
                                <div class="form_flex_radio">
                                    ...
                                    <div class="form_radio">
                                        <input type="radio" id="female" value="F" name="gender" class="action_radio" v-validate="'required'">
                                        <label for="female">Female</label>
                                    </div>
                                    <div class="form_radio">
                                        <input type="radio" id="male" value="M" name="gender" class="action_radio" v-validate="'required'">
            ...
            submissionSuccess () {
                ...
                me.$validator.validateAll().then(valid => {
                    if (valid) {
                        ...
                        me.loader(true)
                        me.$axios.post('api/extras/shoe-sizes', formData).then(res => {
                            setTimeout( () => {
                                if (res.data) {
                                    me.notify('Added')
                                } else {
