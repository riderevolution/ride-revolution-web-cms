                            ...
                            <div class="form_flex">
                                <div class="form_flex_radio">
                                    ...
                                    <div class="form_radio">
                                        <input type="radio" id="female" value="F" name="io_sex" class="action_radio" @change="searchShoeSize(true, 'F')">
                                        <label for="female">Female</label>
                                    </div>
                                    <div class="form_radio">
                                        <input type="radio" id="male" value="M" name="io_sex" class="action_radio" @change="searchShoeSize(true, 'M')">
